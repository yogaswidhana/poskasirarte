...
<head>
    ...
    <title>Login - POS Kasir Artementai</title>
    ...
    <style>
        video {
            ...
            opacity: 0.8; /* untuk mengatur kecerahan video */
        }
        .form-container {
            display: flex;
...
<body>
    ...
    <video autoplay loop muted>
        <source src="assets/img/Vidio.mp4" type="video/mp4">
    </video>
                    ...
                    <div class="card-body p-0">
						...
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login POS Kasir Artementai</b></h4>
							</div>
